...
//min6.0 max 6.5:
const int v6_max_LV_open =526;//norm=504/6.32 //was518on14.04.2023 //526=6.49
...
//min4.8 max5.3:
const int v5_max_LV_open =428;//norm=407/5.15 //was 418on14.04.2023 //428=5.33
const int v5_min_LV_open =379;//norm=407/5.15
const int v5_max_LV_load =419;//norm=398/5.13 //was 411on14.04.2023 //418=5.33
...
//*********test 2*******
  ...
  if((Vmin < analogRead(Uout_meas)) && (analogRead(Uout_meas) < Vmax)) lcd.print("10L-OK"); else {lcd.print("10L-BAD"); bad=true;};   
